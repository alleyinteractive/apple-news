<?php
/**
 * Publish to Apple News tests: Export class
 *
 * @package Apple_News
 * @subpackage Tests
 */

namespace Apple_News\Tests\Admin\Apple_Actions\Index;
...
class Export extends TestCase {
	 ...
	 */
	public static function data_provider_brightcove_video() {
	...
	public function test_has_excerpt() {
		...
		$export           = new \Apple_Actions\Index\Export( $this->settings, $post_id );
	...
	public function test_remove_entities() {
		...
		$markdown_export           = new \Apple_Actions\Index\Export( $this->settings, $post_id );
