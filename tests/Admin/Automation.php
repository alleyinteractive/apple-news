<?php
/**
 * Publish to Apple News Tests: Automation class
 *
...
namespace Apple_News\Tests\Admin;
...
class Automation extends TestCase {
	...
	public function test_settings_migration() {
		...
		$this->assertEquals(
			...
			\Apple_News\Admin\Automation::get_automation_rules()
		);
