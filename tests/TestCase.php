<?php
/**
 * Publish to Apple News tests: TestCase class
 *
 * @package Apple_News
 * @subpackage Tests
 */

namespace Apple_News\Tests;
...
abstract class TestCase extends \WP_UnitTestCase {
	...
	public function setUp(): void {
		...
		$this->content_settings = new Exporter_Content_Settings();
		...
		$this->styles = new Component_Text_Styles(
			$this->content,
		...
		$this->component_styles = new Component_Styles(
			$this->content,
			$this->content_settings
		);
	...
	protected function set_workspace_post_id( $post_id ) {
		$this->workspace = new Workspace( $post_id );
	}
