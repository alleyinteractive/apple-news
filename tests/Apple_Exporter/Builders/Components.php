<?php
/**
 * Publish to Apple News Tests: Components class
 *
 ...
 */
class Components extends TestCase {
	 ...
	 * @return array
	 */
	public static function data_image_full_size_url() {
		return [
	 ...
	 */
	public static function data_meta_component_ordering() {
		return [
			[
				[ 'cover', 'title', 'byline' ],
				[ 'header', 'container' ],
	...
	public function test_get_image_full_size_url( $original, $expected ) {
		...
		$builder = new \Apple_Exporter\Builders\Components( $this->content, $this->content_settings );
