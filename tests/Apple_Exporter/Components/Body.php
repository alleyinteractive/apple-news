<?php
/**
 * Publish to Apple News tests: Body class
 *
 * @package Apple_News
 * @subpackage Tests
 */
...
class Body extends TestCase {
	 ...
	 */
	public static function data_dropcap_determination() {
		return [
...
HTML
	 ...
	 * @return array An array of arrays representing function arguments.
	 */
	public static function data_empty_html() {
		return [
...
HTML
	 ...
	 * @return array An array of arrays representing function arguments.
	 */
	public static function data_link_types() {
		return [
	 ...
	 */
	public static function data_generic() {
		return [
