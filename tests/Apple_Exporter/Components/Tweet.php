<?php
/**
 * Publish to Apple News tests: Tweet class
 *
 * @package Apple_News
 * @subpackage Tests
 */
 ...
 * @subpackage Tests
 */
class Tweet extends Component_TestCase {
	 ...
	 */
	public static function data_tweets() {
		return [
			[
	...
	public function test_component( $html, $url ) {
		$component = new \Apple_Exporter\Components\Tweet(
			$html,
			$this->workspace,
			$this->settings,
			$this->styles,
	...
	public function test_matches_a_single_url() {
		...
		$this->assertNotNull( \Apple_Exporter\Components\Tweet::node_matches( $node ) );
	}
