<?php
/**
 * Publish to Apple News Tests: Parser class
 *
...
class Parser extends TestCase {
	...
	public function test_parse_markdown(): void {
		...
		// Convert to Markdown.
		$parser   = new \Apple_Exporter\Parser( 'markdown' );
	...
	public function test_parse_html(): void {
		...
		$html = ( new \Apple_Exporter\Parser( 'html' ) )->parse( $html_post );
...
HTML;
		...
		$parser      = new \Apple_Exporter\Parser( 'html' );
