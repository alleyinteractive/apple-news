...
function Mappings() {
  ...
  return (
    <div className="apple-news-options__wrapper">
      <h1>{__('Apple News Section Mappings', 'apple-news')}</h1>
      <p>{__('Configure section mappings below to automatically apply certain settings based on the taxonomy terms applied to each post.', 'apple-news')}</p>
